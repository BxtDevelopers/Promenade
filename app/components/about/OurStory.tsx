        ...
        >
          ...
          <div className="mt-8 space-y-5 text-ivory-2 text-[15px] md:text-[16px] font-light leading-[1.7]">
            <p>
              ...
              where every visit starts with listening, where treatment plans
              are explained in plain language, and where families feel
              genuinely cared for, not processed.
            </p>
            <p>
              What began as a small practice with one dental chair has grown
              into a calm, modern space serving families across Chandler —
              but the approach hasn&apos;t changed. One dentist, real time
              with each patient, and a pace that never feels rushed.
            </p>
          </div>
        </div>
      </div>
