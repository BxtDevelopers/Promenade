      ...
      <div className="px-site max-w-[1240px] mx-auto">
        ...
        >
          ...
          <h2 className="font-serif font-light text-3xl
            ...
            <em className="not-italic text-accent">for yourself</em>.
          </h2>

          <p className="text-body text-[15px] md:text-[16px] font-light leading-[1.7] mt-6 max-w-[44ch] mx-auto">
          ...
          <p className="text-body-2 text-[13px] font-light leading-[1.7] mt-10">
