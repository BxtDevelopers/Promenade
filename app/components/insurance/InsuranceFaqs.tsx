...
const FAQS = [
  ...
  },
  {
    ...
    a: "You're still very welcome. New patients can start with our $159 cleaning, exam & X-rays, and we accept HSA and FSA funds. For larger treatment, we offer payment plans so cost never has to delay your care.",
  },
  {
        ...
        <div className="mt-[38px] max-w-[880px] mx-auto space-y-3">
          {FAQS.map((faq, i) => (
            <Reveal key={faq.q} delay={i * 0.05}>
              ...
              >
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 py-5 font-serif text-[19px] font-normal text-ivory marker:content-none">
                  {faq.q}
