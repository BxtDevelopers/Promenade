      ...
      <div className="lg:px-site max-w-[90%] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            {/* Gradient Headline */}
            <h2 className="font-serif font-light text-4xl lg:text-[clamp(40px,4.5vw,64px)] leading-[1.1] tracking-[-0.02em] text-ivory mb-6">
              We work with <br />
            ...
            <p className="text-muted text-[16px] md:text-[17px] font-light leading-[1.75] mb-4 max-w-[48ch]">
              Dental insurance shouldn't be a headache. We accept most major PPO plans and handle the paperwork for you. Our team will verify your benefits and break down costs <em className="text-ivory not-italic font-medium">before</em> treatment begins—no surprises.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-6">
              <a
                href="/insurance"
                className="group inline-flex items-center gap-2 px-6 py-3 bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 hover:border-coral/50 rounded-full text-[14px] text-ivory font-medium transition-all duration-300 shadow-lg"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-[14px] text-ivory/60 font-light hover:text-coral transition-colors"
              >
          ...
          >
            ...
            <div className="p-8 rounded-[24px] bg-white/[0.02] border border-white/10 backdrop-blur-md shadow-2xl">
              <p className="text-[12px] font-bold tracking-[0.15em] uppercase text-ivory mb-6 flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-3">
                {CARRIERS.map((name) => (
                  <span
                    key={name}
                    className="px-4 py-2.5 rounded-full border border-white/10 bg-white/[0.03] text-ivory/80 text-[14px] tracking-wide hover:bg-coral hover:text-white hover:border-coral transition-all duration-300 cursor-default shadow-sm"
                  >
                    {name}
                  </span>
                ))}
            ...
            <div className="group relative p-8 rounded-[24px] bg-gradient-to-br from-coral/10 via-bg to-bg border border-coral/20 overflow-hidden hover:border-coral/40 transition-colors duration-500 shadow-[0_0_30px_rgba(250,114,104,0.05)]">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-ivory font-serif text-2xl group-hover:text-coral transition-colors">No Insurance?</h3>
                ...
                <p className="text-muted text-[15px] font-light leading-[1.7] mb-6">
                  Ask about our <strong className="text-ivory font-medium">In-House Membership Plan</strong>. Pay one simple annual fee for all your preventive care, plus get exclusive discounts on other treatments.
                </p>
