      ...
      <div className="lg:px-site max-w-[90%] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-body text-[16px] md:text-[17px] font-light leading-[1.75] mb-4 max-w-[48ch]">
            ...
            <p className="text-body text-[16px] md:text-[17px] font-light leading-[1.75] mb-10 max-w-[48ch]">
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              >
                ...
                <svg className="w-4 h-4 text-accent group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </a>
              <a
                href="tel:+14808028188"
                className="inline-flex items-center gap-2 text-[14px] text-ink/60 font-light hover:text-accent transition-colors"
              >
          ...
          >
            ...
            <div className="p-8 rounded-[24px] bg-white/[0.02] border border-white/10 backdrop-blur-md shadow-2xl">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-4 py-2.5 rounded-full border border-dashed border-white/20 text-body text-[14px] tracking-wide">
                  + Many More
                </span>
              </div>
              
              <p className="text-body text-[13.5px] font-light leading-[1.6] mt-6 pt-6 border-t border-white/10">
            ...
            <div className="group relative p-8 rounded-[24px] bg-gradient-to-br from-coral/10 via-bg to-bg border border-coral/20 overflow-hidden hover:border-coral/40 transition-colors duration-500 shadow-[0_0_30px_rgba(250,114,104,0.05)]">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-ink font-serif text-2xl group-hover:text-accent transition-colors">No Insurance?</h3>
                  <div className="w-10 h-10 rounded-full bg-coral/10 flex items-center justify-center text-accent">
                ...
                <p className="text-body text-[15px] font-light leading-[1.7] mb-6">
                ...
                <a href="/membership" className="inline-flex items-center text-[14px] font-medium text-accent hover:text-amber-300 transition-colors">
