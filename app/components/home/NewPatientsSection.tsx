        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[50px] lg:gap-[70px] items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <h2 className="font-serif font-light text-3xl
              ...
              You'll know exactly{' '}
              <em className="not-italic text-accent">what to expect</em>.
            </h2>
            ...
            <a
              href="/new-patients"
              className="inline-flex items-center gap-2 mt-8 text-[14px] text-accent font-light tracking-[0.02em]
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-4">
            ...
            <div className="rounded-[14px] border border-line bg-ink/[0.02] px-5 py-4">
              ...
              <p className="text-body text-[12px] mt-2 tracking-[0.03em]">— Chandler patient · Google Review</p>
            </div>
          </div>
