    ...
    return(
        <div className="w-[90%] mx-auto py-24 lg:py-32" >
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium font-['Poppins'] text-[#1A365D]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member) => (
              ...
              >
                ...
                <div className="p-7">
                  <h4 className="text-2xl font-semibold font-['Poppins'] text-[#1A365D]">{member.name}</h4>
                  <p className="text-[#ffa07a] text-[14px] font-['Poppins'] font-semibold mb-3 tracking-wide">{member.role}</p>
                  <p className="text-[#64748B] text-[15px] font-['Poppins'] leading-relaxed font-light">{member.bio}</p>
                </div>
              </div>
            ))}
          </div>
