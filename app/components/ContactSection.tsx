    ...
    <section id="contact" className="bg-white py-24 lg:py-32">
      <div className="w-[90%] mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium font-['Poppins'] text-[#1A365D] mb-5">
            Book Your <span className=" text-[#ffa07a]">Appointment</span>
          </h2>
          <p className="text-[17px] text-[#64748B] font-['Poppins'] max-w-xl mx-auto font-light leading-relaxed">
