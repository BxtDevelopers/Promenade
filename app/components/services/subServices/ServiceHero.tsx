...
export default function ServiceHero({
      ...
      >
        <div className="max-w-5xl items-center">
          ...
          <div>
            ...
            {/* Headline */}
            <h1 className="font-serif font-light text-5xl lg:text-8xl leading-[1.1em] text-ivory">
  ...
  className="max-w-[80%] text-muted text-body-lg font-light leading-[1.7] mt-6"
>
  {description}
</motion.p>
