        ...
        <div className="relative rounded-[2.5rem] bg-[#1A365D] overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center p-6 lg:p-20">
            ...
            >
              ...
              <p className="text-xl text-white/70 font-['Poppins'] font-medium leading-relaxed mb-8 max-w-xl">
              ...
              <div className="flex flex-wrap gap-6 mb-10">
                {[
                  ...
                  <div key={item.text} className="flex items-center gap-2">
                    ...
                    <span className="text-lg text-white/70 font-['Poppins'] font-medium">{item.text}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl">
                ...
                <div className="flex flex-col-reverse md:flex-row items-start justify-between mb-7">
                  <div>
                    ...
                    <h3 className="text-4xl font-bold font-['Sora'] text-[#1A365D] leading-tight">
                      First Visit Package
                    </h3>
                  </div>
