...
export default function AboutSection() {
  return (
    <section id="about" className="bg-white pt-24 lg:pt-32 overflow-hidden">
      <div className="w-[90%] mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium font-['Poppins'] text-[#1A365D] mb-5 leading-tight">
            A Clinic Built on <span className=" text-[#ffa07a]">Trust & Excellence</span>
          </h2>
          <p className="text-[17px] text-[#64748B] font-['Poppins'] max-w-2xl mx-auto leading-relaxed font-light">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-28">
          ...
          <div className="space-y-9">
            <div className="space-y-5">
              <h3 className="text-3xl md:text-4xl font-medium font-['Poppins'] text-[#1A365D] leading-tight">
            ...
            <div className="grid grid-cols-1 gap-3">
              {highlights.map((item) => (
                <div key={item.text} className="flex items-start gap-5 p-5 rounded-2xl bg-gray-50 border border-gray-100 hover:border-[#ffa07a]/30 hover:bg-white hover:shadow-md transition-all group">
                  <div className="w-11 h-11 rounded-xl bg-[#1A365D] flex items-center justify-center shrink-0 group-hover:bg-[#ffa07a] transition-colors">
                    <item.icon className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-[#1A365D] font-['Poppins'] text-[15px] leading-relaxed pt-0.5 font-medium">{item.text}</span>
                </div>
              ))}
            </div>
