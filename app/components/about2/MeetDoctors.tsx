 ...
 * doctors were the bulk of this section's height and made the default view
 * unreadable. <details>/<summary> is keyboard- and screen-reader-accessible
 * with no JavaScript, and the content stays in the DOM for crawlers.
 */
function Credentials({
  ...
  return (
    <details className="group mt-6 border-t border-line pt-4">
      ...
      <div className="mt-5 grid gap-x-8 gap-y-6 lg:grid-cols-2">{children}</div>
    </details>
  )
}
      ...
      <div className="mx-auto max-w-[1240px] px-site">
        ...
        <Reveal className="mt-8 grid grid-cols-1 items-center gap-[clamp(36px,5vw,80px)] lg:grid-cols-[0.82fr_1.18fr]">
          ...
          <div>
            ...
            {/* The standalone credential line was dropped — it repeated the
                first Education entry verbatim. */}
            <h4 className={`mt-5 ${LABEL}`}>Dental Sleep Medicine &amp; Patient Care</h4>
            ...
            <Credentials summary="Focus areas & credentials">
              ...
              <div>
                <h4 className={LABEL}>Education &amp; Advanced Training</h4>
                {eduList(
                  [
        ...
        <Reveal className="mt-[clamp(40px,5vw,72px)] grid grid-cols-1 items-center gap-[clamp(36px,5vw,80px)] lg:grid-cols-[1.18fr_0.82fr]">
          <div className="order-2 lg:order-1">
            ...
            <Credentials summary="Interests & credentials">
              <div>
                <h4 className={LABEL}>Outside the Office</h4>
                {eduList(
                  [
              ...
              <div>
                <h4 className={LABEL}>Education &amp; Training</h4>
                {eduList(
                  [
