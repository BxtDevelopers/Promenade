    ...
    >
      <div className="mx-auto max-w-[1240px] px-[clamp(22px,4vw,60px)]">
        ...
        <div className="flex items-end justify-between gap-[30px] flex-wrap mb-[34px]">
          ...
          >
            Care for{' '}
            <em className="italic text-accent">every need</em>.
          </h2>
        ...
        <div className="grid gap-[18px] grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((s, i) => (
            ...
            >
              ...
              <span className="font-serif text-[13px] tracking-[0.1em] text-body-2">
                {s.num}
              </span>
              ...
              <span
                className="inline-flex items-center gap-2 mt-[18px] text-[13px] tracking-[0.04em] text-accent"
              >
                Explore →
              </span>
            </Link>
        ...
        >
          See all services <span className="text-accent">→</span>
        </Link>
      </div>
    </section>
  )
