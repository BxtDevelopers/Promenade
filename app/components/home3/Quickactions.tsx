...
const actions = [
  {
    ...
    icon: <CalendarCheck className="w-[22px] h-[22px] flex-none text-accent" strokeWidth={1.6} />,
  ...
  {
    href: '/services',
    icon: <LiaToothSolid className="w-[22px] h-[22px] flex-none text-accent" strokeWidth={1.6} />,
    title: 'Our services',
  ...
  },
  {
    ...
    icon: <ShieldAlert className="w-[22px] h-[22px] flex-none text-accent" strokeWidth={1.6} />,
          ...
          a.action === 'book' ? (
            <button key={a.title} type="button" onClick={openBookingModal} className={itemClass}>
              ...
              <div>
                ...
                <span className="block text-xs mt-[1px] text-body">{a.sub}</span>
               <span className="mt-[6px] inline-flex items-center gap-1 text-[11px] font-medium uppercase tracking-[0.05em] text-accent  -translate-x-1 transition-all duration-300 group-hover:translate-x-0">
                  {a.cta}
